...
public class InfoMemberActivity extends AppCompatActivity implements View.OnClickListener, InfoMemberContract.View, MemberEventAdapter.OnEventItemClickListener, PopupMemberAdapter.OnMemberItemClickListener {
    ...
    private ImageView mImageCall, mImageStatus, mImageChat;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.image_chat:
                startActivity(ConversationActivity.getIntent(this, mUserLocation.getUser()));
                break;
    ...
    private void initToolbar() {
        ...
        mImageChat = mToolbar.findViewById(R.id.image_chat);
